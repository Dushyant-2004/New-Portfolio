...
export function Contact() {
  const { ref: sectionRef } = useScrollReveal<HTMLElement>({ threshold: 0.1 });
      ...
      <div className="w-full max-w-[1100px] mx-auto px-6 lg:px-12">
        ...
        <div className="glass-card rounded-[28px] p-8 md:p-12 mb-6">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-[#A7B1C6] text-lg mb-8">
              Tell me what you're looking for. I'll reply within 48 hours.
            </p>

            <a 
              href="mailto:dushyantvasisht@gmail.com"
              className="inline-flex items-center gap-3 text-[#4F6DFF] font-medium text-lg hover:underline"
            >
              <Mail className="w-5 h-5" />
              dushyantvasisht@gmail.com
            </a>
...
function SocialLink({ href, icon, label }: SocialLinkProps) {
  return (
    <a
      href={href}
      className="w-12 h-12 rounded-full bg-[rgba(242,245,250,0.05)] border border-[rgba(242,245,250,0.1)] flex items-center justify-center text-[#A7B1C6] hover:text-white transition-all duration-300"
      aria-label={label}
    >
      {icon}
    </a>
